...
public class Format {
     ...
     */
    public static String centerWithBorder(String string, int width, char fill, char border) {
        String padded = center(string, width - 2, fill);
